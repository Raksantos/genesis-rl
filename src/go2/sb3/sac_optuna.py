...
def evaluate_sac_policy(env, model, n_episodes: int = 10) -> float:
    """
...
def objective(trial, args):
    ...
    if not resume_from_checkpoint:
        ...
        use_auto_ent_coef = trial.suggest_categorical(
            "use_auto_ent_coef", [True, False]
        )
    ...
    try:
        ...
        mean_return = evaluate_sac_policy(
